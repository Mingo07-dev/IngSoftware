...
import farmacie.miglioriconnoi.GestioneSegnalazioni.Control.ControlSegnalazioniRisolte;
...
public class SchermataSegnalazioniRisolte {
    ...
    public SchermataSegnalazioniRisolte() throws FileNotFoundException {
        ...
        ControlSegnalazioniRisolte.fillTable();

        mainPanel.add(sp, BorderLayout.CENTER);

        ControlSegnalazioniRisolte.setListeners();
